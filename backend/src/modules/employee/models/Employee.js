...
employeeSchema.index(
  { employeeCode: 1 },
  { unique: true, name: "uq_employee_code" },
);
employeeSchema.index(
  {
    companyId: 1,
  ...
  { name: "idx_employee_assignment_status" },
);
employeeSchema.index(
  { employmentStatus: 1, recordStatus: 1 },
  { name: "idx_employee_employment_status" },
);
employeeSchema.index(
  { employeeTypeId: 1, recordStatus: 1 },
  { name: "idx_employee_type_status" },
);
employeeSchema.index(
...
employeeSchema.index(
  { exitReasonId: 1, resignDate: 1, employmentStatus: 1, recordStatus: 1 },
  { name: "idx_employee_exit_reason_status" },
);
employeeSchema.index(
  { employeeTypeId: 1, employeeTypeChildId: 1, recordStatus: 1 },
  { name: "idx_employee_type_child_status" },
);
employeeSchema.index(
  { joinDate: 1, resignDate: 1, employmentStatus: 1, recordStatus: 1 },
  { name: "idx_employee_report_active_dates" },
);
employeeSchema.index(
  { employmentStatus: 1, maternityExpectedReturnDate: 1, recordStatus: 1 },
  { name: "idx_employee_maternity_return" },
);
employeeSchema.index(
  {
