...
const attendancePolicySchema = new Schema(
    {
        ...
        earlyCheckInMinutes: { type: Number, min: 0, max: 720, default: 60 },
        ...
        missingOutTimeoutMinutes: { type: Number, min: 60, max: 2880, default: 960 },
        maximumShiftDurationMinutes: { type: Number, min: 60, max: 2880, default: 1080 },
        mergeOvernightScans: { type: Boolean, default: true },
