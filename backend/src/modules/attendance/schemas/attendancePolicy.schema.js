...
export const attendancePolicyPayloadSchema = z.object({
    ...
    earlyCheckInMinutes: z.coerce.number().int().min(0).max(720).default(60),
    ...
    missingOutTimeoutMinutes: z.coerce.number().int().min(60).max(2880).default(960),
    maximumShiftDurationMinutes: z.coerce.number().int().min(60).max(2880).default(1080),
    mergeOvernightScans: z.boolean().default(true),
