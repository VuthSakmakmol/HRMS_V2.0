...
router.get("/position-assignments", requirePermission(EMPLOYEE_TYPE_PERMISSIONS.VIEW), validateRequest({ query: employeeTypeListQuerySchema }), asyncHandler(listEmployeeTypePositionAssignmentsController))
...
router.post("/import-jobs", requirePermission(EMPLOYEE_TYPE_PERMISSIONS.IMPORT), upload.single("file"), validateRequest({ query: employeeTypeListQuerySchema }), asyncHandler(startEmployeeTypeImportJobController))
...
router.post("/import", requirePermission(EMPLOYEE_TYPE_PERMISSIONS.IMPORT), upload.single("file"), validateRequest({ query: employeeTypeListQuerySchema }), asyncHandler(importEmployeeTypesController))
