...
function monthLabel(month) {
    if (month === "AVG") return safeT("excom.attendance.avg", "AVG")

    return safeT(`excom.monthsShort.${month}`, month)
}
...
function rowLabel(row) {
    return safeT(`excom.attendance.codes.${row.code}`, row.label || row.code)
}
</script>
            ...
            <thead>
                <tr>
                    <th class="attendance-detail-table__item">
                        {{ safeT("excom.attendance.detailType", "Detail") }}
                    </th>
                    ...
                    <th>
                        {{ safeT("excom.attendance.avg", "AVG") }}
                    </th>
                </tr>
            </thead>
