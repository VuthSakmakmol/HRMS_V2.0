...
const rankingLabel = computed(() => {
    if (props.wholeYear) return safeT("excom.attendance.wholeYear", "Whole Year")
    if (selectedPeriod.value) return selectedPeriod.value.fullLabel
    return safeT("excom.attendance.ytd", "YTD")
})
                ...
                <thead>
                    <tr>
                        <th class="attendance-department-rank-table__department">
                            {{ safeT("excom.attendance.department", "Department") }}
                        </th>
                        ...
                        <th class="attendance-department-rank-table__rate">
                            {{ safeT("excom.attendance.absentRate", "Absent rate (%)") }}
                        </th>

                        <th class="attendance-department-rank-table__rate is-workforce-rate">
                            {{ safeT("excom.attendance.absentRateWithoutAnnualMaternity", "Absent rate (%)-ANL&MA") }}
                        </th>
                    </tr>
                </thead>
