...
const props = defineProps({
    // Kept for compatibility with ExcomDashboardView. Attendance now builds
...
/*
 * selectedLabel is supplied by Excom's common scope resolver.
...
const sectionTitle = computed(() =>
    `${selectedScopeLabel.value} ${safeT("excom.attendance.absent", "Absent")}`
        .replace(/\s+/g, " ")
        .trim(),
)
    ...
    <section class="dashboard-section attendance-dashboard-section">
        ...
        <div class="attendance-section-filter">
            <div class="attendance-section-filter__mode">
                <Button
                    :label="safeT('excom.attendance.totalView', 'Total')"
                    size="small"
                ...
                <Button
                    :label="safeT('excom.attendance.detailView', 'Detail')"
                    size="small"
