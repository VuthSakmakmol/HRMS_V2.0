...
const inOutTitle = computed(() => {
    const inLabel = t("excom.movement.in")
    const outLabel = t("excom.movement.out")
            ...
            <table class="movement-table">
                ...
                <tbody>
                    ...
                    <tr class="movement-balance">
                        <th>{{ t("excom.movement.balance") }}</th>
