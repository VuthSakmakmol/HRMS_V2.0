...
function monthLabel(period) {
    return t(`excom.monthsShort.${period.month}`)
}
                ...
                <thead>
                    ...
                    <tr class="recruitment-table__header-row">
                        ...
                        <th class="recruitment-table__channel">
                            {{ t("excom.recruitment.channels") }}
                        </th>
                        <th>{{ t("excom.recruitment.previousAveragePerMonth") }}</th>
                        <th class="recruitment-table__target">
                            {{ t("excom.recruitment.targetPerMonth") }}
                        </th>
                        <th
                            v-for="period in periods"
                            :key="period.key"
                        ...
                        <th>{{ t("excom.recruitment.averagePerMonth") }}</th>
                    </tr>
                </thead>
...
/*
 * Fixed 100% layout: all 12 months always fit inside the Excom card.
...
/* Selected reporting month follows the same Excom red-range standard. */
