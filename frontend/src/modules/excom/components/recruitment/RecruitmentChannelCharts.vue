        ...
        <div class="recruitment-pie-card">
            <div class="recruitment-pie-card__chart">
                <svg
                    viewBox="0 0 220 180"
                    role="img"
                    :aria-label="t('excom.recruitment.previousYearChart')"
                >
                    <path
            ...
            <div class="recruitment-pie-card__title">
                {{ t("excom.recruitment.previousYearChart", { year: data.previousYear }) }}
            </div>
        </div>
        ...
        <div class="recruitment-pie-card">
            <div class="recruitment-pie-card__chart">
                <svg
                    viewBox="0 0 220 180"
                    role="img"
                    :aria-label="t('excom.recruitment.currentYearChart')"
                >
                    <path
            ...
            <div class="recruitment-pie-card__title">
                {{ t("excom.recruitment.currentYearChart", { year: data.currentYear }) }}
            </div>
        </div>
    </div>
</template>
