...
const selectedLabel = computed(() => {
    return props.data.selectedLabel ||
        ...
        safeT("excom.general.selected", "Selected")
})
...
const cards = computed(() => [
    {
        key: "averageAge",
        icon: "pi pi-users",
        label: safeT("excom.general.averageAge", "Avg. Age"),
        firstLabel: safeT("excom.general.total", "Total"),
        ...
        suffix: safeT("excom.units.years", "years"),
    },
    {
        key: "averageService",
        icon: "pi pi-briefcase",
        label: safeT("excom.general.averageService", "Years Of Service"),
        firstLabel: safeT("excom.general.total", "Total"),
        ...
        >
            <table class="general-workforce-table">
                <thead>
                    <tr>
                        <th class="general-workforce-table__category">
                            {{ safeT("excom.general.category", "Category") }}
                        </th>
                        <th class="general-workforce-table__department">
                            {{ safeT("excom.general.positions", "Positions") }}
                        </th>
                        <th class="general-workforce-table__count">
                            {{ workforceCategory.monthLabel || safeT("excom.general.selectedMonth", "Selected") }}
                        </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr class="is-total">
                        <td colspan="2">
                            {{ safeT("excom.general.grandTotal", "Grand Total") }}
                        </td>
            ...
            >
                ...
                <span>
                    {{
                        safeT(
                            "excom.general.unassignedEmployeeTypeWarning",
