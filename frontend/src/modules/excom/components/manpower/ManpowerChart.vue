...
const chartData = computed(() => ({
    labels: props.rows.map((row) => t(`excom.monthsShort.${row.month}`)),
    datasets: [
        {
            type: "bar",
            label: `Target: ${t("excom.manpower.roadmap")}`,
        ...
        {
            type: "bar",
            label: `+/- ${t("excom.manpower.overLessRoadmap")}`,
        ...
        {
            type: "line",
            label: t("excom.manpower.fillRate"),
...
const permanentValueLabelsPlugin = {
    id: "excomManpowerPermanentValueLabels",
    afterDatasetsDraw(chart) {
