...
const metrics = computed(() => [
    {
        key: "budget",
        labelKey: "excom.manpower.budget",
        className: "metric-budget",
    },
    {
        key: "roadmap",
        labelKey: "excom.manpower.roadmap",
        className: "metric-roadmap",
    },
    {
        key: "actual",
        labelKey: "excom.manpower.actual",
        className: "metric-actual",
    },
    {
        key: "targetGap",
        labelKey: "excom.manpower.overLessTarget",
        className: "metric-target-gap",
        signed: true,
    },
    {
        key: "roadmapGap",
        labelKey: "excom.manpower.overLessRoadmap",
        className: "metric-roadmap-gap",
        signed: true,
    },
    {
        key: "fillRate",
        labelKey: "excom.manpower.fillRate",
