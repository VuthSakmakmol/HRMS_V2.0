    ...
    >
        <div class="dashboard-filter-bar__fields">
            <EnterpriseCalendarDatePicker
                ...
                compact
                show-status
                :placeholder="t('excome.filters.startDate')"
            ...
            <EnterpriseCalendarDatePicker
                ...
                compact
                show-status
                :placeholder="t('excome.filters.endDate')"
            ...
            <Select
                ...
                :option-label="optionLabel"
                option-value="id"
                :placeholder="t('excome.filters.allShifts')"
                show-clear
                filter
                :loading="lookupLoading"
            ...
            <Select
                ...
                :option-label="optionLabel"
                option-value="id"
                :placeholder="t('excome.filters.allDepartments')"
                show-clear
                filter
                :loading="lookupLoading"
            ...
            <Select
                ...
                :option-label="optionLabel"
                option-value="id"
                :placeholder="t('excome.filters.allPositions')"
                show-clear
                filter
                :loading="lookupLoading"
            ...
            <Select
                ...
                :option-label="optionLabel"
                option-value="id"
                :placeholder="t('excome.filters.allLines')"
                show-clear
                filter
                :loading="lookupLoading"
