...
function monthLabel(period) {
    return safeT(`excome.monthsShort.${period.month}`, period.label || period.month)
}
...
function rowTitle() {
    const label = props.selectedLabel || safeT("excome.attendance.selectedScope", "Selected")

    return safeT("excome.attendance.topAbsentTitle", "Top absent by department").replace("{label}", label)
}
</script>
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            ...
                            :key="period.key"
                            :class="{ 'is-selected-period': period.key === selectedPeriodKey }"
                        >
                            {{ monthLabel(period) }}
                        </th>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td
                            ...
                            :class="{ 'is-selected-period': month.key === selectedPeriodKey }"
                        >
...
.attendance-top-absent-table .is-selected-period {
    border-right: 2px solid #ef4444 !important;
    border-left: 2px solid #ef4444 !important;
}

.attendance-top-absent-table thead .is-selected-period {
    border-top: 2px solid #ef4444 !important;
}

.attendance-top-absent-table tbody tr:last-child .is-selected-period {
