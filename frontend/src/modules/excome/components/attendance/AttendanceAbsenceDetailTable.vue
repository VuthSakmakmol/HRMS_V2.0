...
function monthLabel(month) {
    if (month === "AVG") return safeT("excome.attendance.avg", "AVG")

    return safeT(`excome.monthsShort.${month}`, month)
}
...
function rowLabel(row) {
    return safeT(`excome.attendance.codes.${row.code}`, row.label || row.code)
}
</script>
            ...
            <thead>
                <tr>
                    <th class="attendance-detail-table__item">
                        {{ safeT("excome.attendance.detailType", "Detail") }}
                    </th>
                    ...
                    <th>
                        {{ safeT("excome.attendance.avg", "AVG") }}
                    </th>
                </tr>
            </thead>
