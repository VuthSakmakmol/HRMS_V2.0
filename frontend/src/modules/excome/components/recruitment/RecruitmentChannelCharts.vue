        ...
        <div class="recruitment-pie-card">
            <div class="recruitment-pie-card__chart">
                <svg
                    viewBox="0 0 220 180"
                    role="img"
                    :aria-label="t('excome.recruitment.previousYearChart')"
                >
                    <path
            ...
            <div class="recruitment-pie-card__title">
                {{ t("excome.recruitment.previousYearChart", { year: data.previousYear }) }}
            </div>
        </div>
        ...
        <div class="recruitment-pie-card">
            <div class="recruitment-pie-card__chart">
                <svg
                    viewBox="0 0 220 180"
                    role="img"
                    :aria-label="t('excome.recruitment.currentYearChart')"
                >
                    <path
            ...
            <div class="recruitment-pie-card__title">
                {{ t("excome.recruitment.currentYearChart", { year: data.currentYear }) }}
            </div>
        </div>
    </div>
</template>
