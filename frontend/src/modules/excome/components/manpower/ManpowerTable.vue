...
const metrics = computed(() => [
    {
        key: "budget",
        labelKey: "excome.manpower.budget",
        className: "metric-budget",
    },
    {
        key: "roadmap",
        labelKey: "excome.manpower.roadmap",
        className: "metric-roadmap",
    },
    {
        key: "actual",
        labelKey: "excome.manpower.actual",
        className: "metric-actual",
    },
    {
        key: "targetGap",
        labelKey: "excome.manpower.overLessTarget",
        className: "metric-target-gap",
        signed: true,
    },
    {
        key: "roadmapGap",
        labelKey: "excome.manpower.overLessRoadmap",
        className: "metric-roadmap-gap",
        signed: true,
    },
    {
        key: "fillRate",
        labelKey: "excome.manpower.fillRate",
