...
export const EMPLOYEE_COLUMNS = Object.freeze([
  ...
  column("basic", "dateOfBirth", "Date of Birth", {
    width: "10rem",
    minWidth: "10rem",
  }),
  ...
  column("contact", "nationality", "Nationality", {
    width: "10rem",
    minWidth: "10rem",
  }),
  ...
  column("employment", "joinDate", "Join Date", {
    width: "10rem",
    minWidth: "10rem",
  }),
  column("employment", "recruitmentChannel", "Recruitment Channel", {
    width: "13rem",
  }),
  column("employment", "employmentStatus", "Employment Status"),
  column("employment", "resignDate", "Exit Date", {
    width: "10rem",
    minWidth: "10rem",
  }),
  ...
  column("employment", "recordStatus", "Record Status", {
    width: "10rem",
    minWidth: "10rem",
  }),

  column("addresses", "birthAddressDetail", "Birth Address", {
    width: "18rem",
  }),
  column("addresses", "permanentAddressDetail", "Permanent Address", {
    width: "18rem",
  }),

  column("documents", "idCardNo", "ID Card Number"),
  column("documents", "idCardExpireDate", "ID Card Expiry", {
    width: "10rem",
    minWidth: "10rem",
  }),
  column("documents", "nssfNo", "NSSF Number"),
  column("documents", "passportNo", "Passport Number"),
  column("documents", "passportExpireDate", "Passport Expiry", {
    width: "10rem",
    minWidth: "10rem",
  }),
  column("documents", "visaExpireDate", "Visa Expiry", {
    width: "10rem",
    minWidth: "10rem",
  }),
  column("documents", "medicalCheckNo", "Medical Check Number", {
    width: "13rem",
  }),
  column("documents", "medicalCheckDate", "Medical Check Date", {
    width: "11rem",
  }),
  column("documents", "workingBookNo", "Working Book Number", {
    width: "13rem",
  }),

  column("skills", "singleNeedle", "Single Needle", {
    width: "9rem",
    minWidth: "9rem",
  }),
  column("skills", "overlock", "Overlock", { width: "8rem", minWidth: "8rem" }),
  column("skills", "coverstitch", "Coverstitch", {
    width: "9rem",
    minWidth: "9rem",
  }),
  column("skills", "totalMachines", "Total Machines", {
    width: "9rem",
    minWidth: "9rem",
  }),
...
export function defaultEmployeeColumns() {
  return EMPLOYEE_COLUMNS.filter((columnItem) => columnItem.default).map(
    (columnItem) => columnItem.field,
  );
}
