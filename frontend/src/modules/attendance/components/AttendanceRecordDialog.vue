...
<template>
  <EnterpriseDialog
    :visible="visible"
    :title="editing ? 'Correct Attendance Record' : 'Add Attendance Record'"
    width="44rem"
    :busy="saving"
  ...
  >
    <div class="record-form">
      ...
      /></label>
      <label class="wide"
        ><span>Correction Reason / Note <b>*</b></span
        ><Textarea
          v-model="form.note"
          rows="3"
          maxlength="1000"
    ...
    <template #footer
      ><EnterpriseFormFooter
        :saving="saving"
        :disabled="
          !form.employeeCode || !form.attendanceDate || !form.note.trim()
        "
