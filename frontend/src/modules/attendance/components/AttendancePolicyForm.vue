...
<template>
  <div class="policy-form">
    <div class="scope">
      <div>
        <small>Company</small><strong>{{ companyName || "—" }}</strong>
      </div>
      <i class="pi pi-angle-right" />
      <div>
        <small>Branch</small><strong>{{ branchName || "—" }}</strong>
      </div>
    </div>
    <label
      ><span>Code <b>*</b></span
      ><InputText
        ...
        :disabled="disabled || editing" /></label
    ><label
      ><span>Policy Name <b>*</b></span
      ><InputText v-model.trim="model.name" :disabled="disabled"
    /></label>
    <label
    ...
    <label
      ...
      ><InputNumber
        v-model="model.graceInMinutes"
        :min="0"
        :max="240"
        :use-grouping="false" /></label
    ><label
      ><span>Grace Out (minutes)</span
      ><InputNumber
        v-model="model.graceOutMinutes"
        :min="0"
        :max="240"
        :use-grouping="false" /></label
    ><label
      ...
      ><InputNumber
        v-model="model.minimumWorkedMinutes"
        :min="0"
        :max="1440"
        :use-grouping="false" /></label
    ><label
    ...
    <label
      ...
      ><InputNumber
        v-model="model.lateRoundUnitMinutes"
        :min="1"
        :max="240"
        :use-grouping="false" /></label
    ><label
    ...
    ><label
      ...
      ><InputNumber
        v-model="model.earlyLeaveRoundUnitMinutes"
        :min="1"
        :max="240"
        :use-grouping="false" /></label
    ><label
    ...
    <div class="check">
      <Checkbox
        ...
        binary
        input-id="autoAbsent"
      /><label for="autoAbsent">Automatically generate absence</label>
    </div>
    <div class="check">
      <Checkbox
        ...
        binary
        input-id="sundayRest"
      /><label for="sundayRest">Treat Sunday as rest day</label>
    </div>
  </div>
</template>
<style scoped>
